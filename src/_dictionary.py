...
"""Dictionary class and related functions.

A dictionary maps sequences of key strokes to translations.
...
#from asetniop import normalize

class Dictionary(collections.MutableMapping):
    """A dictionary.
